            ...
            <div class=" h-20 w-24 relative">
                <!-- img div -->
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="space-y-2">
                            <h4 class="text-[20px] font-semibold">10 kids unware of their holloewe eedff</h4>
                            <p class="text-gray-400">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Exercitationem amet consectetur, eaque aspernatur magni obcaecati!</p>
                            <div class="border-b-2 border-dotted border-gray-400"></div>
                                <!-- icon div -->
                            <div class="flex justify-between p-2">
                                <div class="flex gap-6">
                                    <p>
                                        <i class="fa-regular fa-message"></i> <span>123</span>
                                        </p>
                                        <p>
                                        <i class="fa-regular fa-eye"></i><span>11212</span>
                                    </p>
                                    <p>
                                        <i class="fa-regular fa-clock"></i><span>5min</span>
                                    </p>
                                </div>
